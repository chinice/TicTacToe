 ...
 *
 *
 * This is a MultiPlayerGame activity class.
 * This class handles the game logic for a multi-player game
 */
...
public class MultiPlayerGameActivity extends AppCompatActivity {
    ...
    /**
     * Onclick method called when a user clicks on the button during a game
     *
     * @param view
     */
        ...
        if (gameover == 1) {
            ...
            builder.setPositiveButton("OK",new DialogInterface.OnClickListener(){
                public void onClick(DialogInterface dialog, int id){
                    Intent mainActivity = new Intent(MultiPlayerGameActivity.this, ScoreBoardActivity.class);
                    mainActivity.putExtra("Player 1 Wins", player1Win);
                    mainActivity.putExtra("Player 2 Wins", player2Win);
                    mainActivity.putExtra("Draws", draw);
                    mainActivity.putExtra("Player 1 Name", player1Name);
                    mainActivity.putExtra("Player 2 Name", player2Name);
    ...
    /**
     * Checks if there is a winner in an ongoing game
     */
    ...
    /**
     * Click event method to start a new game
     *
     * @param view
     */
